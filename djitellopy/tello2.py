...
class Tello:
    ...
    def run_udp_receiver(self):
        ...
        while True:
            try:
                self.response, _ = self.clientSocket.recvfrom(2048)  # buffer size is 1024 bytes
            except Exception as e:
                print(e)
                break

    def get_udp_video_address(self):
        return 'udp://@' + self.VS_UDP_IP + ':' + str(self.VS_UDP_PORT)   + '?overrun_nonfatal=1&fifo_size=5000000'
