...
try:	
 while True:
            button01IM = pygame.image.load("button01M.png")            
            ...
            screen.blit(button01IM,(100,10))            
            screen.blit(button01IM,(250,10))            
            screen.blit(button01IM,(400,10))
            ...
            for event in pygame.event.get():
                            if event.type == KEYDOWN:
                               if event.key == pygame.K_LSHIFT:
                                  a = True
                                  while a:
                                         head1 = pygame.image.load("button01P.png")
                                         button01P = pygame.image.load("button01P.png")                                         
                                         head2 = pygame.image.load("HUDP.png")
                                         ret, frame = camera.read()
                                         screen.fill([0,0,0])
                                         frame = cv2.cvtColor(frame, cv2.COLOR_BGR2HSV)
                                         frame = np.rot90(frame)
                                         frame = pygame.surfarray.make_surface(frame)
                                         screen.blit(frame, (0,0))
                                         screen.blit(button01P,(100,10))            
                                         screen.blit(button01P,(250,10))            
                                         screen.blit(head2,(10,75))
                                         pygame.display.update()
                                         for event in pygame.event.get():
                                                         if event.type == KEYDOWN:
                                                               ...
                                                               if event.key == pygame.K_LSHIFT:
                                                                  ...
                                                                  while b:
                                                                          ...
                                                                          screen.blit(button01IM,(100,10))            
                                                                          screen.blit(button01IM,(250,10))            
                                                                          screen.blit(head3,(0,0))                                                                          
                                                                          pygame.display.update()
                                                                          for event in pygame.event.get():
                                                                                          if event.type == KEYDOWN:
                                                                                             if event.key == pygame.K_LCTRL:
                                                                                                head3 = pygame.image.load("input3.png")
                                                                                             if event.key == pygame.K_ESCAPE:
                                                                                                sys.exit(0)
                                                                                             if event.key == pygame.K_LSHIFT:
                                                                                                c = True
